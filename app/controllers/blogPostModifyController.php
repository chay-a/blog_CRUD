...
if (isset($queryId)) {
    ...
    if (isset($submit)){
        ...
        if ($nbError == 0){
            ...
            blogPostCreate($dbh, $inputsSanitized['title'], $queryId, $inputsSanitized['content'], $inputsSanitized['startDate'], $inputsSanitized['endDate'], $inputsSanitized['rank'], $authorId);
        }
    }
