...
include 'ressources/views/header.tpl.php'; ?>
    ...
    <div class="container">
        <div class="row card text-center">
            <p class="card-header"><?php foreach ($categories as $Name): $printCategories .= $Name['Name'] . ', '; endforeach;
                echo $printCategories; ?></p>
            <div class="card-body">
...
<?php
require 'ressources/views/commentCreate.tpl.php';
